...
func (n *FullNode) StartQueryAPI(port int) error {
	...
	mux.HandleFunc("/chain-state", n.handleChainState())
	...
	mux.HandleFunc("/contract/", n.handleContract())
...
func (n *FullNode) handleChainInfo() http.HandlerFunc {
...
func (n *FullNode) handleChainState() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		if r.Method != http.MethodGet {
			http.Error(w, "Method not allowed", http.StatusMethodNotAllowed)
			return
...
func (n *FullNode) handleSubmitBlock() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func (n *FullNode) handleGetMempool() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		if r.Method != http.MethodGet {
			http.Error(w, "Method not allowed", http.StatusMethodNotAllowed)
			return
...
func (n *FullNode) handleSubmitTransaction() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		if r.Method != http.MethodPost {
			http.Error(w, "Method not allowed", http.StatusMethodNotAllowed)
			return
...
func (n *FullNode) handleBalance() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		if r.Method != http.MethodGet {
			http.Error(w, "Method not allowed", http.StatusMethodNotAllowed)
			return
...
func (n *FullNode) handleTransaction() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		if r.Method != http.MethodGet {
			http.Error(w, "Method not allowed", http.StatusMethodNotAllowed)
			return
...
func (n *FullNode) handleBlock() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		if r.Method != http.MethodGet {
			http.Error(w, "Method not allowed", http.StatusMethodNotAllowed)
			return
...
func (n *FullNode) handleContract() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		if r.Method != http.MethodGet {
			http.Error(w, "Method not allowed", http.StatusMethodNotAllowed)
			return
