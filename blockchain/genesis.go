...
func init() {
	...
	header := types.BlockHeader{
		Version:      1,
		PreviousHash: types.Hash32{},                                                                                                                                                                                               // All zeros for genesis
		Height:       0,                                                                                                                                                                                                            // Genesis is height 0
		Timestamp:    1609459200,                                                                                                                                                                                                   // Fixed timestamp (Jan 1, 2021)
		Nonce:        1944729,                                                                                                                                                                                                      // Properly mined valid nonce
		MerkleRoot:   types.Hash32{0xc6, 0xa0, 0xbb, 0x4e, 0xea, 0xe3, 0x33, 0xa9, 0x82, 0xc7, 0x0c, 0xe1, 0x15, 0x44, 0x0b, 0x89, 0xdb, 0x8f, 0x6e, 0x2e, 0x36, 0x19, 0x3e, 0x65, 0x7f, 0xa9, 0x57, 0x68, 0xee, 0xa3, 0x30, 0x00}, // Actual computed merkle root
		StateRoot:    types.Hash32{},                                                                                                                                                                                               // Empty state root for genesis
		ReceiptRoot:  types.Hash32{},                                                                                                                                                                                               // No receipts in genesis
		...
		Beneficiary:  types.PublicKey{},                                                                                                                                                                                                  // No beneficiary for genesis
	}

	// Create the hardcoded genesis block
	GenesisBlock = &types.Block{
		Header:       header,
		Transactions: []types.Transaction{genesisCoinbase},
	}
